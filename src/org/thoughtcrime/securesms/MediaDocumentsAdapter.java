...
public class MediaDocumentsAdapter extends CursorRecyclerViewAdapter<ViewHolder>
  ...
  public ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
    return new ViewHolder(
        LayoutInflater.from(getContext())
            .inflate(R.layout.media_overview_document_item, parent, false));
  }
  ...
  public void onBindItemViewHolder(ViewHolder viewHolder, @NonNull Cursor cursor) {
    ...
    if (slide != null && slide.hasDocument()) {
      ...
      viewHolder.date.setText(
          DateUtils.getRelativeDate(getContext(), locale, mediaRecord.getDate()));
      viewHolder.documentView.setVisibility(View.VISIBLE);
      viewHolder.date.setVisibility(View.VISIBLE);
      viewHolder.documentView.setOnClickListener(
          view -> {
  ...
  public HeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
    return new HeaderViewHolder(
        LayoutInflater.from(getContext())
            .inflate(R.layout.media_overview_document_item_header, parent, false));
  }
