...
public class BitmapUtil {
  ...
  public static <T> ScaleResult createScaledBytes(
      Context context, T model, MediaConstraints constraints) throws BitmapDecodingException {
    try {
      ...
      Bitmap scaledBitmap =
          GlideApp.with(context.getApplicationContext())
              ...
              .submit(constraints.getImageMaxWidth(context), constraints.getImageMaxWidth(context))
              .get();
      ...
      try {
          ...
          int nextQuality =
              (int)
                  Math.floor(
                      quality
                          * Math.sqrt(
                              (double) constraints.getImageMaxSize(context) / bytes.length));
        ...
        Log.w(
            ...
            "createScaledBytes("
                + model.toString()
                + ") -> quality "
                + Math.min(quality, MAX_COMPRESSION_QUALITY)
                + ", "
                + attempts
                + " attempt(s)");
