...
public interface MmsSmsColumns {
  ...
  public static class Types {
    ...
    public static boolean isPendingMessageType(long type) {
      return (type & BASE_TYPE_MASK) == BASE_OUTBOX_TYPE
    ...
    public static boolean isLegacyType(long type) {
      return (type & ENCRYPTION_REMOTE_LEGACY_BIT) != 0 || (type & ENCRYPTION_REMOTE_BIT) != 0;
    }
    ...
    //    public static final int FAILED_TYPE         = 5;
    //
    //    public static final int OUTBOX_TYPE = 43;  // Messages are stored local encrypted and need
    // delivery.
    //
    //
    //    public static final int ENCRYPTING_TYPE      = 42;  // Messages are stored local encrypted
    // and need async encryption and delivery.
    //    public static final int SECURE_SENT_TYPE     = 44;  // Messages were sent with async
    // encryption.
    //    public static final int SECURE_RECEIVED_TYPE = 45;  // Messages were received with async
    // decryption.
    //    public static final int FAILED_DECRYPT_TYPE  = 46;  // Messages were received with async
    // encryption and failed to decrypt.
    //    public static final int DECRYPTING_TYPE      = 47;  // Messages are in the process of
    // being asymmetricaly decrypted.
    //    public static final int NO_SESSION_TYPE      = 48;  // Messages were received with async
    // encryption but there is no session yet.
    //
    ...
    //
    //    public static final int[] OUTGOING_MESSAGE_TYPES = {SENT_TYPE, SENT_PENDING,
    // ENCRYPTING_TYPE,
    //                                                        OUTBOX_TYPE, SECURE_SENT_TYPE,
    //                                                        FAILED_TYPE,
    // OUTGOING_KEY_EXCHANGE_TYPE};
    //
    //    public static boolean isFailedMessageType(long type) {
