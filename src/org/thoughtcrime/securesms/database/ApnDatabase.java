...
public class ApnDatabase {
  ...
  private ApnDatabase(final Context context) throws IOException {
    ...
    Util.copy(
        context.getAssets().open(ASSET_PATH, AssetManager.ACCESS_STREAMING),
  ...
  private Apn getCustomApnParameters() {
    ...
    if (!TextUtils.isEmpty(mmsc) && !mmsc.startsWith("http")) mmsc = "http://" + mmsc;
  ...
  public Apn getDefaultApnParameters(String mccmnc, String apn) {
    ...
    try {
      ...
      if (cursor == null || !cursor.moveToFirst()) {
        ...
        cursor =
            db.query(TABLE_NAME, null, BASE_SELECTION, new String[] {mccmnc}, null, null, null);
      }
