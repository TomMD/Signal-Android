...
/**
 * Represents the message record model for MMS messages that contain media (ie: they've been
 * downloaded).
 *
 * @author Moxie Marlinspike
 */
public class MediaMmsMessageRecord extends MmsMessageRecord {
  private static final String TAG = MediaMmsMessageRecord.class.getSimpleName();

  private final Context context;
  private final int partCount;

  public MediaMmsMessageRecord(
      Context context,
      long id,
  ...
  public SpannableString getDisplayBody() {
    if (MmsDatabase.Types.isFailedDecryptType(type)) {
      ...
      return emphasisAdded(
          context.getString(
              R.string.MmsMessageRecord_mms_message_encrypted_for_non_existing_session));
