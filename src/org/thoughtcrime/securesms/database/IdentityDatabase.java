...
public class IdentityDatabase extends Database {
  ...
  public void saveIdentity(
    ...
    EventBus.getDefault()
        .post(
            new IdentityRecord(
                address, identityKey, verifiedStatus, firstUse, timestamp, nonBlockingApproval));
  }
  ...
  private IdentityRecord getIdentityRecord(@NonNull Cursor cursor)
    ...
    boolean nonblockingApproval =
        cursor.getInt(cursor.getColumnIndexOrThrow(NONBLOCKING_APPROVAL)) == 1;
