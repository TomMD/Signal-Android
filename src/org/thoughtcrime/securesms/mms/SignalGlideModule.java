...
public class SignalGlideModule extends AppGlideModule {
  ...
  public void registerComponents(
    ...
    registry.prepend(
        File.class,
        Bitmap.class,
        new EncryptedBitmapCacheDecoder(
            secret,
    ...
    registry.prepend(
        File.class,
        GifDrawable.class,
        new EncryptedGifCacheDecoder(
            secret,
            new StreamGifDecoder(
                registry.getImageHeaderParsers(),
    ...
    registry.append(
        AttachmentModel.class, InputStream.class, new AttachmentStreamUriLoader.Factory());
