    ...
    AlertDialog dialog =
        new AlertDialog.Builder(this)
            ...
            .setMessage(
                getString(
                    R.string
                        .DeviceProvisioningActivity_it_looks_like_youre_trying_to_link_a_signal_device_using_a_3rd_party_scanner))
            .setPositiveButton(
                R.string.DeviceProvisioningActivity_continue,
                (dialog1, which) -> {
            ...
            .setNegativeButton(
                R.string.DeviceProvisioningActivity_cancel,
                (dialog12, which) -> {
                  dialog12.dismiss();
                  finish();
                })
