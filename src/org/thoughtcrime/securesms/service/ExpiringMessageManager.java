...
public class ExpiringMessageManager {
  ...
  private final TreeSet<ExpiringMessageReference> expiringMessageReferences =
      new TreeSet<>(new ExpiringMessageComparator());
  ...
  public void scheduleDeletion(
      long id, boolean mms, long startedAtTimestamp, long expiresInMillis) {
  ...
  private class LoadTask implements Runnable {
    public void run() {
      SmsDatabase.Reader smsReader =
          smsDatabase.readerFor(smsDatabase.getExpirationStartedMessages());
  ...
  private static class ExpiringMessageReference {
    ...
    public boolean equals(Object other) {
      ...
      return this.id == that.id
          && this.mms == that.mms
          && this.expiresAtMillis == that.expiresAtMillis;
    }
