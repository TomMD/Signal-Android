...
public class GiphyActivity extends PassphraseRequiredActionBarActivity
  ...
  private void initializeResources() {
    ...
    viewPager.setAdapter(
        new GiphyFragmentPagerAdapter(
            this, getSupportFragmentManager(), gifFragment, stickerFragment));
    ...
    new AsyncTask<Void, Void, Uri>() {
      ...
      protected Uri doInBackground(Void... params) {
        try {
          ...
          return PersistentBlobProvider.getInstance(GiphyActivity.this)
              .create(GiphyActivity.this, data, "image/gif", null);
  ...
  private static class GiphyFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    private GiphyFragmentPagerAdapter(
