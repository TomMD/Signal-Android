...
public class GiphyStickerLoader extends GiphyLoader {
  ...
  protected String getTrendingUrl() {
    return "https://api.giphy.com/v1/stickers/trending?api_key=3o6ZsYH6U6Eri53TXy&offset=%d&limit="
        + PAGE_SIZE;
  }

  @Override
  protected String getSearchUrl() {
    return "https://api.giphy.com/v1/stickers/search?q=cat&api_key=3o6ZsYH6U6Eri53TXy&offset=%d&limit="
        + PAGE_SIZE
        + "&q=%s";
  }
}
