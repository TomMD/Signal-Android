 ...
 *
 * <p>Calls all registered handlers in reverse order of registration. Errors in one handler do not
 * prevent subsequent handlers from being called.
 */
public class UncaughtExceptionHandlerManager implements Thread.UncaughtExceptionHandler {
  ...
  private final List<Thread.UncaughtExceptionHandler> handlers =
      new ArrayList<Thread.UncaughtExceptionHandler>();
