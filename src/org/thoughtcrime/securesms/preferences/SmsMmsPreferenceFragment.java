...
public class SmsMmsPreferenceFragment extends CorrectedPreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    this.findPreference(MMS_PREF).setOnPreferenceClickListener(new ApnPreferencesClickListener());
  ...
  public void onResume() {
    ...
    ((ApplicationPreferencesActivity) getActivity())
        .getSupportActionBar()
        .setTitle(R.string.preferences__sms_mms);
  ...
  private void initializeDefaultPreference() {
    ...
    if (Util.isDefaultSmsProvider(getActivity())) {
      ...
      defaultPreference.setSummary(
          getString(R.string.ApplicationPreferencesActivity_touch_to_change_your_default_sms_app));
    } else {
      ...
      defaultPreference.setSummary(
          getString(
              R.string.ApplicationPreferencesActivity_touch_to_make_signal_your_default_sms_app));
    }
  }
