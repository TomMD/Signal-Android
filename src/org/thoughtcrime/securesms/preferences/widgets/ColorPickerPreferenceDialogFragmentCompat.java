...
public class ColorPickerPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat
  ...
  public static ColorPickerPreferenceDialogFragmentCompat newInstance(String key) {
    ColorPickerPreferenceDialogFragmentCompat fragment =
        new ColorPickerPreferenceDialogFragmentCompat();
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    ColorPickerDialog.Params params =
        new ColorPickerDialog.Params.Builder(getContext())
