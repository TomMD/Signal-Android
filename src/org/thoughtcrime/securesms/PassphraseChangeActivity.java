...
public class PassphraseChangeActivity extends PassphraseActivity {
  ...
  private void verifyAndSavePassphrases() {
    ...
    if (!passphrase.equals(passphraseRepeat)) {
      ...
      new ChangePassphraseTask(this)
          .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, original, passphrase);
    }
  }
    ...
    protected MasterSecret doInBackground(String... params) {
      try {
        MasterSecret masterSecret =
            MasterSecretUtil.changeMasterSecretPassphrase(context, params[0], params[1]);
