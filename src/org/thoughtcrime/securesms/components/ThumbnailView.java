...
public class ThumbnailView extends FrameLayout {
  ...
  public ThumbnailView(final Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      ...
      backgroundColorHint =
          typedArray.getColor(R.styleable.ThumbnailView_backgroundColorHint, Color.BLACK);
  ...
  public void setImageResource(
    ...
    if (slide.getThumbnailUri() != null)
      buildThumbnailGlideRequest(glideRequests, slide).into(image);
  ...
  private GlideRequest buildThumbnailGlideRequest(
  ...
  private RequestBuilder buildPlaceholderGlideRequest(
      @NonNull GlideRequests glideRequests, @NonNull Slide slide) {
    return applySizing(
        glideRequests
            .asBitmap()
  ...
  private GlideRequest applySizing(
      @NonNull GlideRequest request, @NonNull BitmapTransformation unavailableDimensSizing) {
    int[] size = new int[2];
