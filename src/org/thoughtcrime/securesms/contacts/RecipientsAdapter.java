...
public class RecipientsAdapter extends ResourceCursorAdapter {
  ...
  public final CharSequence convertToString(Cursor cursor) {
    ...
    out.setSpan(
        new Annotation("label", displayLabel.toString()),
        0,
        len,
  ...
  public final void bindView(View view, Context context, Cursor cursor) {
    ...
    label.setText(
        mContactAccessor.phoneTypeToString(mContext, type, cursor.getString(LABEL_INDEX)));
  ...
  /**
   * Returns true if all the characters are meaningful as digits in a phone number -- letters,
