...
public class RegistrationLockDialog {
  ...
  public static void showReminderIfNecessary(@NonNull Context context) {
    ...
    dialog
        .getWindow()
        .setLayout((int) (metrics.widthPixels * .80), ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    SpannableString reminderIntro =
        new SpannableString(context.getString(R.string.RegistrationLockDialog_reminder));
    SpannableString reminderText =
        new SpannableString(
            context.getString(
                R.string
                    .RegistrationLockDialog_registration_lock_is_enabled_for_your_phone_number));
    SpannableString forgotText =
        new SpannableString(context.getString(R.string.RegistrationLockDialog_i_forgot_my_pin));
        ...
        new ClickableSpan() {
          ...
          public void onClick(View widget) {
            ...
            new AlertDialog.Builder(context)
                .setTitle(R.string.RegistrationLockDialog_forgotten_pin)
                .setMessage(
                    R.string
                        .RegistrationLockDialog_registration_lock_helps_protect_your_phone_number_from_unauthorized_registration_attempts)
    ...
    reminderIntro.setSpan(
        new StyleSpan(Typeface.BOLD), 0, reminderIntro.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    forgotText.setSpan(clickableSpan, 0, forgotText.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

    reminder.setText(
        new SpannableStringBuilder(reminderIntro)
            .append(" ")
            .append(reminderText)
            .append(" ")
            .append(forgotText));
        ...
        new TextWatcher() {
          ...
          public void afterTextChanged(Editable s) {
            if (s != null
                && s.toString()
                    .replace(" ", "")
                    .equals(TextSecurePreferences.getRegistrationLockPin(context))) {
              dialog.dismiss();
  ...
  public static void showRegistrationLockPrompt(
              ...
              v -> {
                ...
                if (pinValue.length() < 4) {
                  Toast.makeText(
                          context,
                          R.string
                              .RegistrationLockDialog_the_registration_lock_pin_must_be_at_least_four_digits,
                          Toast.LENGTH_LONG)
                      .show();
                  return;
                }
                ...
                if (!pinValue.equals(repeatValue)) {
                  Toast.makeText(
                          context,
                          R.string.RegistrationLockDialog_the_two_pins_you_entered_do_not_match,
                          Toast.LENGTH_LONG)
                      .show();
                  return;
                }
                ...
                new AsyncTask<Void, Void, Boolean>() {
                  ...
                  protected Boolean doInBackground(Void... voids) {
                    try {
                      ...
                      TextSecurePreferences.setRegistrationLockNextReminderInterval(
                          context, RegistrationLockReminders.INITIAL_INTERVAL);
                      return true;
                    } catch (IOException e) {
                      Log.w(TAG, e);
                      return false;
                  ...
                  protected void onPostExecute(@NonNull Boolean result) {
                    ...
                    if (result) {
                      ...
                      Toast.makeText(
                              context,
                              R.string.RegistrationLockDialog_error_connecting_to_the_service,
                              Toast.LENGTH_LONG)
                          .show();
                    }
                  }
  ...
  @SuppressLint("StaticFieldLeak")
  public static void showRegistrationUnlockPrompt(
      @NonNull Context context,
      @NonNull SwitchPreferenceCompat preference,
      @NonNull SignalServiceAccountManager accountManager) {
    AlertDialog dialog =
