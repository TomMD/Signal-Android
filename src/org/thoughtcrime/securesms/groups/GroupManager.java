...
public class GroupManager {
  ...
  public static @NonNull GroupActionResult createGroup(
    ...
    final Recipient groupRecipient =
    ...
    if (!mms) {
      ...
      long threadId =
          DatabaseFactory.getThreadDatabase(context)
              .getThreadIdFor(groupRecipient, ThreadDatabase.DistributionTypes.CONVERSATION);
  ...
  private static GroupActionResult sendGroupUpdate(
      @NonNull Context context,
      @NonNull String groupId,
    ...
    try {
      ...
      GroupContext.Builder groupContextBuilder =
      ...
      OutgoingGroupMediaMessage outgoingMessage =
          new OutgoingGroupMediaMessage(
              groupRecipient, groupContext, avatarAttachment, System.currentTimeMillis(), 0);
