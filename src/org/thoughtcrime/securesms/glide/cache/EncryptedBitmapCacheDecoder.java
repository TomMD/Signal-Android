...
public class EncryptedBitmapCacheDecoder extends EncryptedCoder
    implements ResourceDecoder<File, Bitmap> {
  ...
  public EncryptedBitmapCacheDecoder(
      @NonNull byte[] secret, @NonNull StreamBitmapDecoder streamBitmapDecoder) {
    this.secret = secret;
  ...
  public Resource<Bitmap> decode(
      @NonNull File source, int width, int height, @NonNull Options options) throws IOException {
