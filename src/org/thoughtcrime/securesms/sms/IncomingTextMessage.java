...
public class IncomingTextMessage implements Parcelable {
  ...
  public static final Parcelable.Creator<IncomingTextMessage> CREATOR =
      new Parcelable.Creator<IncomingTextMessage>() {
        @Override
  ...
  public IncomingTextMessage(
      @NonNull Context context, @NonNull SmsMessage message, int subscriptionId) {
  ...
  public IncomingTextMessage(
    ...
    if (group.isPresent()) {
      this.groupId =
          Address.fromSerialized(GroupUtil.getEncodedId(group.get().getGroupId(), false));
    } else {
      this.groupId = null;
    }
  }
