...
/**
 * When a user first initializes TextSecure, a few secrets are generated. These are:
 *
 * <p>1) A 128bit symmetric encryption key. 2) A 160bit symmetric MAC key. 3) An ECC keypair.
 *
 * <p>The first two, along with the ECC keypair's private key, are then encrypted on disk using PBE.
 *
 * <p>This class represents 1 and 2.
 *
...
public class MasterSecret implements Parcelable {
  ...
  public static final Parcelable.Creator<MasterSecret> CREATOR =
      new Parcelable.Creator<MasterSecret>() {
        @Override
