...
public class ScribbleToolbar extends Toolbar implements View.OnClickListener {
  ...
  @Nullable private ScribbleToolbarListener listener;
  ...
  private void setBrushSelected(boolean enabled) {
    if (enabled) {
      ...
      this.textView.setColorFilter(
          new PorterDuffColorFilter(foregroundUnselectedTint, PorterDuff.Mode.MULTIPLY));

      this.brushView.setBackground(background);
      this.brushView.setColorFilter(
          new PorterDuffColorFilter(foregroundSelectedTint, PorterDuff.Mode.MULTIPLY));

      this.stickerView.setBackground(null);
      this.stickerView.setColorFilter(
          new PorterDuffColorFilter(foregroundUnselectedTint, PorterDuff.Mode.MULTIPLY));
