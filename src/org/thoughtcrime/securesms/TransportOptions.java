...
public class TransportOptions {
  ...
  public TransportOptions(Context context, boolean media) {
    ...
    this.defaultSubscriptionId =
        new SubscriptionManagerCompat(context).getPreferredSubscriptionId();
  }
  ...
  private List<TransportOption> initializeAvailableTransports(boolean isMediaMessage) {
    ...
    if (isMediaMessage) {
      results.addAll(
          getTransportOptionsForSimCards(
  ...
  private @NonNull List<TransportOption> getTransportOptionsForSimCards(
      @NonNull String text,
